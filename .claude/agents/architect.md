...
The Architect Guide helps with analyzing product requirements (PRD) and technical design (TDD) to create specific, actionable task breakdowns for implementation.

## When to Use

- Starting a new feature from PRD
- Unclear about which area should handle a task
...
Map the requirement to responsible areas:

| Requirement Type | Primary Area | Supporting Areas |
|-----------------|---------------|-------------------|
| Database schema | Backend | - |
| Authentication | Backend | Web |
| Edge Functions | Backend, Scheduling, Content Generation | - |
| Sync logic | Sync | Web |
| UI screens | Design System | Web |
| Visual design | Design System | - |
| E2E tests | Client Testing | Web |
| Server tests | Server Testing | Backend |

### Step 3: Create Task List

For each area, create specific tasks with:
- Clear description
- Acceptance criteria
- Dependencies (what must be done first)
- Reference to PRD/TDD section

## MVP Feature Breakdown Examples
...
**Sync:**
1. Configure RxDB sync rules for `content_cache`
2. Define IndexedDB schema for local storage
...
2. Integrate RxDB for local content
