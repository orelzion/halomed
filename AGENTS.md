# HaLomeid (הלומד) - Codex Project Guide
...
| **Agents Guide** | `.Codex/agents/README.md` | Role-specific development guides |
...
When working on specific areas, reference the appropriate guide in `.Codex/agents/`:
